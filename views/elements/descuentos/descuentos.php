                        ...
                        <tr class="TrRow">
                            ...
                            <td scope="row">
                                <div class="btn-group Editbuttons" aria-label="Grupo edicion">
                                    <button type="button" class="btn btn-success EditDescuentoBtn" data-id='<?= $desc["iddescuento"] ?>' data-activo="<?= $desc["activo"] ?>" data-descripcion="<?= $desc["descripcion"] ?>" data-descuento="<?= $desc["descuento"] ?>"><?= $icons['edit'] ?></button>
